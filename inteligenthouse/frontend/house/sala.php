...
<body>
    ...
    <section class="container mt-4">
        <div class="row">
            ...
            <div class="col-md-6">
                <img src="images/living_room_lights.jpg" class="img-fluid" alt="Control de Iluminación">
            </div>
        </div>
        <div class="row mt-4">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <img src="images/living_room_blinds.jpg" class="img-fluid" alt="Control de Persianas">
            </div>
        </div>
        <div class="row mt-4">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <img src="images/voice_assistant.jpg" class="img-fluid" alt="Integración con Asistentes de Voz">
            </div>
        </div>
    </section>
